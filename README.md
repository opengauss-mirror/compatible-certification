...
- 步骤2. 提交申请   
  伙伴根据[测试报告模板](testing-standard/openGauss技术测评兼容性测试用例（ISV商用软件）模板V2.docx)，结合自身产品使用方法，输出测评方案。并在compatible-certification仓库按[issue提交模板](docs/兼容性测评申请模板--issue提交模板.txt)发起测评申请   
...
| 技术测评对象      | 用例基线                  | 测试工具               | 说明 |
| ------------ | ------------------------- | ---------------------- | ---- |
| ISV商用软件   | [ISV商用软件测试用例集](testing-standard/openGauss技术测评兼容性测试用例（ISV商用软件）模板V2.docx)     | gsql|      |
